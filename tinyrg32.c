...
#define rgp uint32_t  // Or even ./tinyrg32 --hex --stream '¡La niña!'
...
,p=2,c,j;rgl(m,b,v[g-1]);rgf(8)j=rgi(m,b,&p);j=(j<<24|j>>8<<24>>8|j<<8
>>24<<8|j>>24);printf(g&1?"%c":"%08x",j);c-=g>2;}return printf("\n");}
